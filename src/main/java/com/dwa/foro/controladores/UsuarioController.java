...
public class UsuarioController {
	...
	public String agregar(@RequestParam("username") String correoe,//cambio de correoe por username
			 @RequestParam("password") String clave,////cambio de clave por password
			 Model modelo) { ////////
